  ...
  return (
    <div>
      ...
      <div className="mb-3 flex cursor-pointer items-center space-x-3  border-b px-4 pb-3">
        ...
        <div>
          <p className="text-sm font-medium text-gray-700">말딱</p>
      ...
      <div>
        <div className="mt-2 px-4 text-gray-700">
          <span className="font-medium text-orange-500">Q.</span> 은평구
          어느곳이 맛집인지
        </div>
      ...
      <div className="my-5 space-y-5 px-4">
        <div className="flex items-start space-x-3">
          ...
          <div>
            ...
            <p className="mt-2 text-gray-700">구파발 넙딱집이 제일 낫다</p>
          </div>
        </div>
      </div>
      <div className="px-4">
